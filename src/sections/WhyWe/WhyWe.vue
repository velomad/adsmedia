<template>
  ...
  >
    <slide class="space-y-6">
      <div class="text-center text-4xl text-gray-700">
      ...
      <div class="grid grid-cols-3 place-items-center space-x-4 p-2">
        ...
        <div class="text-center text-2xl col-span-2 text-gray-500">
    ...
    <slide class="space-y-6">
      <div class="text-center text-4xl text-gray-700">We Give Results</div>
      <div class="grid grid-cols-3 place-items-center space-x-4 p-2">
        <div>
    ...
    <slide class="space-y-6">
      <div class="text-center text-4xl text-gray-700">Our creative Support</div>
      <div class="grid grid-cols-3 place-items-center space-x-4 p-2">
        <div>
          <img src="@/assets/slider2.svg" alt="" width="300" />
        </div>
        <div class="text-center text-2xl text-gray-500 col-span-2">
