<template>
  <div>
    <div
      class="w-full px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 py-16 mx-auto bg-white text-gray-900"
    >
    ...
    <header>
      ...
      >
        <section
          class="text-gray-600 body-font bg-fixed bg-purple-900 bg-opacity-50"
        >
          <div class="container px-5 py-24 mx-auto">
            ...
            >
              ...
              >
                ...
                <div class="flex-grow">
                  <h2 class="text-white text-xl title-font font-medium mb-3">
                    Address
                  </h2>
    ...
    <section class="text-gray-600 body-font relative">
      ...
      <div class="container px-5 py-40 mx-auto flex"></div>
    </section>
  </div>
</template>
<script>
